...
{
    plot4c_on_ctx2( id_name, ctx, 0, 686, 0, 380 );
}

function plot4c_on_ctx2( id_name, ctx, plot_x_init, plot_length, plot_y_init, plot_height )
{

    var plot_endin_x = plot_length;
    var plot_endin_y = plot_height - 20;
    if ( $( "#" + id_name ).data("error") )
    {
        ctx.fillStyle = "rgba(0,0,0,1)";
        ctx.textAlign="center";
        ctx.fillText("Error: Your requested region could not be retrieved.", plot_length/2, plot_height/2);
        ctx.fillText( $( "#" + id_name ).data("error") , plot_length/2, plot_height/2+20);
        return;
    }
...
////////y-axis label
    ...
    ctx.fillText(y_label, plot_start_x+(plot_endin_y-plot_start_y)/2, plot_length+32);
    ctx.restore();
