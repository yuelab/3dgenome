...
function drawHeatMap( canvas_id )
{
    ...
    drawHeatMap_on_ctx( canvas_id, ctx, canvas_width, 0, canvas_height );
}
...
function draw_rect( ctx, tad_start, tad_end, index )
{
    ...
    ctx.fillRect( get_g_to_x_coord(tad_start), canvas_endin_y-10, get_g_to_x_coord(tad_end)-get_g_to_x_coord(tad_start), 10);
}
