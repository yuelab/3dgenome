...
/////////////////////////////////////////
    ...
    ctx.strokeStyle = getRgbaStr( $('#colorInput' ).val(), 0.75);
    ctx.stroke();
...
function drawIndicator(canvas_id, x, y)
{
    ...
    //draw indicator ball
    ctx.strokeStyle = getRgbaStr( $('#colorInput' ).val(), 1.0 );
    ctx.beginPath();
    ...
    ctx.fillStyle = getRgbaStr( $('#colorInput' ).val(), 0.25 );
    ...
    if (dtx)
    {
        ...
        dtx.fillStyle = getRgbaStr( $('#colorInput' ).val(), 0.25 );
    ...
    $('.chiaPlot').each(function() {
        if (this.id.split('_')[1] == canvas_id.split('_')[1])
        {
            ...
            if (rtx)
            {
                ...
                rtx.fillStyle = getRgbaStr( $('#colorInput' ).val(), 0.25 );
...
function retrieveHighlight(canvas_id, mouseLeftFlag)
{
    ...
    if (etx)
    {
        ...
        etx.fillStyle = getRgbaStr( $('#colorInput' ).val(), 0.25 );
    }
